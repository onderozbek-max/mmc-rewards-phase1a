...
export interface Milestone {
   ...
   * running product yet. Phase 1A operationalizes only the first milestone
   * (250) — "What's New" and "Member Favorites" genuinely unlock at that
   * threshold. 1,000 and 3,000 are real future milestones on the roadmap,
   * but are NOT wired to any benefit yet, and must never be presented as an
   * active "next benefit" promise, no matter how many lifetime points a
   * member has. Operationalizing them is Phase 1E scope.
   */
  operational: boolean;
}
...
/** The one milestone Phase 1A actually operationalizes. */
