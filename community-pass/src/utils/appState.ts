 ...
 * consistently — no screen may show a stale total.
 */
 ...
 * progress-delta message is shown (that explicit feedback is out of scope
 * for this phase). Idempotent: completing the same activity twice never
 * awards points twice.
 */
